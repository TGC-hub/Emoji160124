...
public class CrossbowView : MonoBehaviour
{
...
/*        if (isPhone)
        {*/
            ...
            if (Input.touchCount > 0 && CheckRawImage.Instance.IsPointerDown == true)
            {
...
/*        else
        {
            if (Input.GetMouseButton(0) && CheckRawImage.Instance.IsPointerDown == true)
            {
                if (isFirst)
                {
                    isFirst = false;
