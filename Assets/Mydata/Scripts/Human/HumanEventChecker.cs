...
{
    [SerializeField] private float stateStart;
    public float StateStart => stateStart;
    ...
    public bool OnWaiting => onWaiting;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("Arrow"))
        {
            ...
            //controller.SingleEffectCtrl.SpawnSingleEffect(typeEmoji);
    ...
    protected virtual void DespawnIcon(GameObject icon)
    {
        if(icon == null) return;
