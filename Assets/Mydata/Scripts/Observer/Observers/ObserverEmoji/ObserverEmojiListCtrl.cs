...
public class ObserverEmojiListCtrl : MyMonoBehavior
{
    ...
    {
        if(MissionManager.Instance.MissionValue == type) { EvaluationCtrl.Instance.SetCurrentValuation(10); }
        else { EvaluationCtrl.Instance.SetCurrentValuation(-10);}
        switch (type)
        {
            case 0:
                ObserverHappy.Instance.OnActiveInterface();
                EvaluationCtrl.Instance.SetCurrentValuation(20);
                break;
            case 1:
                ObserverAngry.Instance.OnActiveInterface();
                EvaluationCtrl.Instance.SetCurrentValuation(-15);
                break;
            case 2:
                ObserverCry.Instance.OnActiveInterface();
                EvaluationCtrl.Instance.SetCurrentValuation(-5);
                break;
            case 3:
